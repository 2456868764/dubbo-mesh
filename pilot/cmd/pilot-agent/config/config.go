...
import (
	...
	dubbomeshconstants "dubbo-mesh/pilot/pkg/constants"
...
func ConstructProxyConfig(meshConfigFile, serviceCluster, proxyConfigEnv string, concurrency int) (*meshconfig.ProxyConfig, error) {
	...
	// Reset ConfigPath
	if proxyConfig.ConfigPath == constants.ConfigPathDir {
		proxyConfig.ConfigPath = dubbomeshconstants.ConfigPathDir
	}
